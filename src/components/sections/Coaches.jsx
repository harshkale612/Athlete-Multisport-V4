          ...
          {filteredOptions.map((coach, idx) => (
             ...
             >
               <div className="flex items-center gap-4 mb-6">
                 <img src={coach.imageUrl} alt={coach.name} className="w-16 h-16 rounded-full object-cover border-2 border-contrast-alpha/20 group-hover:border-primary transition-colors" />
                 <div>
                   <h3 className="text-xl font-bold text-text group-hover:text-primary transition-colors">{coach.name}</h3>
